package com.pp.accounts.controller;

import com.pp.accounts.constants.AccountsConstants;
import com.pp.accounts.dto.CustomerDto;
import com.pp.accounts.dto.ErrorResponseDto;
import com.pp.accounts.dto.ResponseDto;
...
public class AccountsController {
    ...
    public ResponseEntity<CustomerDto> fetchAccountDetails(@RequestParam
                                                               @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number should be of 10 digits") String mobileNumber){
